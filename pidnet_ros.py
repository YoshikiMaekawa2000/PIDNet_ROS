...
class PIDNet:
    def __init__(self):
        ...
        self.model = pidnet.get_pred_model('pidnet-s', 19)
        self.model = load_pretrained(self.model, os.path.join(os.getcwd() + weight_path))
        # self.model = load_pretrained(self.model, os.path.join(os.getcwd() + weight_path)).cuda()
        self.model.eval()
